...
class Driver extends Model
{
 ...
 /**
     * URL фото водителя (локальный storage или внешний URL).
     */
    public function getPhotoUrlAttribute(): ?string
    {
        return $this->getDocumentUrlAttribute('photo');
    }

    /**
     * URL фото прав (локальный storage или внешний URL).
     */
    public function getLicensePhotoUrlAttribute(): ?string
    {
        return $this->getDocumentUrlAttribute('license_photo');
    }

    /**
     * URL фото медсправки (локальный storage или внешний URL).
     */
    public function getMedicalCertificatePhotoUrlAttribute(): ?string
    {
        return $this->getDocumentUrlAttribute('medical_certificate_photo');
    }

    private function getDocumentUrlAttribute(string $attribute): ?string
    {
