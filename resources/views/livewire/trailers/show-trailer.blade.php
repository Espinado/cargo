        ...
        <div class="bg-gray-50 p-6 rounded-2xl shadow-inner mb-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-4">
                <div class="border rounded-2xl p-2 flex items-center justify-center h-56 bg-white shadow-sm">
                    @if($trailer->tech_passport_photo_url)
                        <a href="{{ $trailer->tech_passport_photo_url }}" target="_blank" rel="noopener">
                            <img src="{{ $trailer->tech_passport_photo_url }}" alt="Tech Passport"
                                 class="h-full object-contain rounded-xl" loading="lazy">
                        </a>
                    @else
