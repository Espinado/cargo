<div class="p-4 sm:p-6 max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow border border-gray-200 p-6">
        <h1 class="text-xl font-semibold text-gray-900 mb-4">{{ __('app.carriers.create_title') }}</h1>
        <p class="text-sm text-gray-500 mb-6">{{ __('app.carriers.create_hint') }}</p>
        ...
        <form wire:submit.prevent="save" class="space-y-4">
            ...
            <div class="flex gap-2 pt-2">
                ...
                <a href="{{ route('carriers.index') }}" wire:navigate class="px-4 py-2 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200">{{ __('app.carriers.back') }}</a>
            </div>
        </form>
    </div>
</div>
