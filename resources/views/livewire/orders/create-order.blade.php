    ...
    <div class="bg-white shadow rounded-xl border border-gray-200 p-4 sm:p-6">
        ...
        <form wire:submit.prevent="save" class="space-y-4">
            ...
            <div class="flex items-center gap-3 pt-2">
                <button type="submit" class="px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700">{{ __('app.orders.add') }}</button>
                <a href="{{ route('orders.index') }}" wire:navigate class="text-gray-600 hover:text-gray-900 text-sm">{{ __('app.orders.show.back') }}</a>
            </div>
        </form>
    </div>
</div>
